...
export default function DashboardScreen({ navigation }) {
  const [analytics, setAnalytics] = useState({ trust_score: 0, sold_items: 0, total_purchases: 0, rating: 0 });
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <View style={styles.logoContainer}>
            <Image
              ...
              resizeMode="contain"
            />
            <Text style={styles.logoText}>UniFind</Text>
          </View>
        ...
        <View style={styles.greetingSection}>
          ...
          <Text style={styles.subtitle}>Welcome back to UniFind</Text>
        </View>
        ...
        >
          <View style={styles.trustContent}>
            <View style={styles.trustLeft}>
              ...
              <Text style={styles.trustScore}>{analytics.trust_score || 0}%</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.statsRow}>
            <View style={styles.statCard}>
              ...
              <Text style={styles.statValue}>{analytics.total_purchases || 0}</Text>
            ...
            <View style={styles.statCard}>
              ...
              <Text style={styles.statValue}>{analytics.sold_items || 0}</Text>
            ...
            <View style={styles.statCard}>
              ...
              <Text style={styles.statValue}>{analytics.rating?.toFixed(1) || '0.0'}</Text>
