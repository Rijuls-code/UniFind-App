...
const PostListingPage = () => {
  ...
  const uploadToCloudinary = async (file) => {
    ...
    const uploadPreset = 'unifind_products';
            ...
            <div className="flex justify-between mt-8 pt-8 border-t border-slate-200">
              ...
              {step < 3 ? (
                ...
                <Button
                  ...
                  disabled={loading}
                  className="bg-green-600 text-white font-medium px-6 py-3 rounded-xl hover:bg-green-700 transition-all duration-200 active:scale-95 disabled:opacity-50"
