      ...
      <div className="px-6 sm:px-8 md:px-12 lg:px-24 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-white rounded-2xl border border-slate-200 p-6" data-testid="metric-bought">
            ...
            <div className="text-3xl font-black text-slate-900 mb-1">{userStats.bought}</div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6" data-testid="metric-earnings">
            ...
            <div className="text-3xl font-black text-slate-900 mb-1">₹{userStats.earnings.toLocaleString()}</div>
            <div className="flex items-center gap-1 text-sm text-green-600">
              <TrendingUp className="h-4 w-4" />
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6" data-testid="metric-rating">
            ...
            <div className="text-3xl font-black text-slate-900 mb-1">{userStats.rating}</div>
            <div className="flex items-center gap-1 text-sm text-green-600">
              <TrendingUp className="h-4 w-4" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-8 text-white" data-testid="earnings-card">
            ...
            <div className="text-4xl font-black mb-4">₹{userStats.earnings.toLocaleString()}</div>
            <div className="text-sm text-blue-100">From {userStats.sold} successful sales</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-600 to-green-700 rounded-2xl p-8 text-white" data-testid="savings-card">
            ...
            <div className="text-4xl font-black mb-4">₹{userStats.savings.toLocaleString()}</div>
            <div className="text-sm text-green-100">From {userStats.bought} smart purchases</div>
          </div>
        </div>
      </div>
    </div>
